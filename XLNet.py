...
def generate_text_xlnet(prompt, max_new_tokens=50):
...
for tweet in df['tweet']:
    ...
    generated_text = generate_text_xlnet(tweet)
    generated_texts.append(generated_text)

df['generated_text'] = generated_texts
output_file_path = '/scratch/sxm6547/CSE_584/Midterm_project/xlnet.csv'  # Update this with your desired output path

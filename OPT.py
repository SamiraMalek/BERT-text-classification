...
def generate_text_opt(prompt, max_new_tokens=50):
...
for tweet in df['tweet']:
    ...
    generated_text = generate_text_opt(tweet)
    generated_texts.append(generated_text)

# Save the input and generated output in a new CSV
df['generated_text'] = generated_texts
output_file_path = '/scratch/sxm6547/CSE_584/Midterm_project/opt.csv'  # Update this with your desired output path
